            ...
            <tbody>
                <tr>
                    ...
                    <form action='../controller/controladorCoordiandor.php'>
                        <td><a href='../controller/controladorCoordinador.php?id=".$data['id']."&value=Borra'><input type='button' name='btnBorrarCoordinador' value='Borrar'></a></td>
                        <td><a href='../controller/controladorCoordinador.php?id=".$data['id']."&value=Actualiza'><input type='button' name='btnActualizarCoordinador' value='Actualizar'></a></td>
                    </form>
                </tr>
            </tbody>
            ");
